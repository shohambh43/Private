...
function isPreloadable(linkElement) {
  /*
  Preloading any <a href="" ... ></a> element on mouse hover is causing cart item removal button to be clicked multiple times,
  removing items that customer doesn't want to remove. So we are disabling all preloading here.
  */
  return
